...
from rasa_nlu.extractors.composite_entity_extractor import CompositeEntityExtractor
from rasa_nlu.extractors.composite_data_extractor import CompositeDataExtractor
